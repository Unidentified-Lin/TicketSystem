        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreaterId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ResolverId = table.Column<Guid>(type: "TEXT", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ResolvedDate = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tickets", x => x.Guid);
                    table.ForeignKey(
                        name: "FK_Tickets_AspNetUsers_CreaterId",
                        column: x => x.CreaterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tickets_AspNetUsers_ResolverId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_CreaterId",
                table: "Tickets",
                column: "CreaterId");

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_ResolverId",
                table: "Tickets",
                column: "ResolverId");
        }
